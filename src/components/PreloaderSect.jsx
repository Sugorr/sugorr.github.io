...
export default function PreloaderSect () {
    return (
        <div className="w-screen h-screen inset-0 overflow-hidden absolute z-[100] m-0 bg-default-white grid place-content-center">
            <motion.svg
            initial={{ rotate: 0, opacity: 0, y:45, x: 120}}
            animate={{
                rotate: 720,
                opacity: 1,
                x: 0,
            ...
            width="96" height="96" viewBox="0 0 49 48" fill="none" xmlns="http://www.w3.org/2000/svg">
